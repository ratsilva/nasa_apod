...
class NasaPictureGetListUseCase with UseCase<Unit, List<NasaPicture>> {
  final NasaPictureRepository _nasaPictureRepository;

  const NasaPictureGetListUseCase(this._nasaPictureRepository);

  @override
  Stream<Result<List<NasaPicture>, NasaPictureGetListException>> call(Unit params) {
    return _nasaPictureRepository.getList();
  }
}
